class Calculator {
    constructor() {
        ...
        this.displayElement = this.element.find(".display div.equasion");
        this.equasionDisplayElement = this.element.find(".display input.equasion");
        this.resultElement = this.element.find(".display .result");
        this.calculateElement = this.element.find(".key.calculate");
        this.revertKey = this.element.find("[data-action='revert']")
        this.clearKey = this.element.find("[data-action='clear']")
    ...
    inputMode() {
        ...
        this.revertKey.removeClass("hidden");
        this.clearKey.addClass("hidden");
        this.update();
    }

    resultMode() {
        this.mode = "result";
        this.revertKey.addClass("hidden");
        this.clearKey.removeClass("hidden");
        this.update();
    }
    ...
    update() {
        ...
        this.equasionDisplayElement.val(this.equasion.toString());

        if (this.mode == "result") {
            this.displayElement.html(this.equasion.toResultHTML());
        } else {
            this.displayElement.html(this.equasion.toStaticHTML());
        }
    }
    ...
    calculate() {
        ...
        if (this.equasion.valid) {
            ...
            this.resultElement.text(`\xa0= ${this.equasion.result}`);
