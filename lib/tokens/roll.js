class Roll extends Token {
    ...
    // unify the html and adapt the css
    dieHTML(value) {
        if (this.dieSize == 4) {
            return `
              <div class="token die d${this.dieSize}">
                  <div class="cutter shadow"></div>
                  <div class="cutter shadow dark"></div>
                  <div class="cutter"></div>
                  <div class="value">${value}</div>
              </div>
          `;
        } else if (this.dieSize == 6) {
            return `
              <div class="token die d6">
                <div class="cutter shadow dark"></div>
                <div class="cutter shadow"></div>
                <div class="cutter"></div>
          ...
          `;
        } else if (this.dieSize == 8) {
            return `
            <div class="token die d8">
                <div class="cutter shadow"></div>
                <div class="cutter shadow dark"></div>
                <div class="cutter"></div>
        ...
        `;
        } else if (this.dieSize == 10) {
            return `
              <div class="token die d10">
                  <div class="cutter shadow"></div>
                  <div class="cutter shadow dark"></div>
                  <div class="cutter"></div>
        ...
        `;
        } else if (this.dieSize == 12) {
            return `
              <div class="token die d12">
                  <div class="cutter shadow"></div>
          ...
          `;
        } else if (this.dieSize == 20) {
            return `
              <div class="token die d20">
                  <div class="cutter shadow"></div>
                  <div class="cutter shadow light"></div>
                  <div class="cutter shadow dark"></div>
                  <div class="cutter"></div>
          ...
          `;
            ...
            return `
              <div class="token die dx">
                  <div class="cutter"></div>
                  <div class="value">${this.dieSize}</div>
              </div>
          `;
        }
    }
